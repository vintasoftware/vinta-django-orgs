...
class OrganizationSpecificTablesGroup(SingleOrganizationModelMixin):
    ...
    permissions = models.ManyToManyField(
        'organizations_custom_data.OrganizationSpecificTablesPermission', blank=True, related_name='groups'
    )
...
class OrganizationSpecificTablesRelationship(SingleOrganizationModelMixin):
    ...
    groups = models.ManyToManyField(
        'organizations_custom_data.OrganizationSpecificTablesGroup', related_name='relationships'
    )
    permissions = models.ManyToManyField(
        'organizations_custom_data.OrganizationSpecificTablesPermission', related_name='relationships'
    )
...
class OrganizationSpecificFieldDefinition(SingleOrganizationModelMixin):
    ...
    validators = models.ManyToManyField('organizations_custom_data.OrganizationSpecificFieldsValidator', blank=True)
    ...
    def __str__(self) -> str:
        ...
        if content_type == 'organizations.OrganizationSpecificTable':
