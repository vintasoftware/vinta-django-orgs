...
from organizations_custom_data.querysets import OrganizationSpecificFieldsQueryset
...
class OrganizationSpecificFieldsModelManager(_OrganizationSpecificFieldsManagerBase):
    ...
    def get_queryset(self, *args: Any, **kwargs: Any) -> QuerySet[Any]:
        from organizations_custom_data.models import OrganizationSpecificTableRow
