...
* every write to :class:`~organizations.models.Organization` or
  :class:`~organizations.models.OrganizationSite` drops the affected entries, and
...
@receiver(post_save, sender='organizations.OrganizationSite')
@receiver(post_delete, sender='organizations.OrganizationSite')
